...
export const EXPORT_BUDGET_FIELD = "aigpuExportBundleBudgetsGzipBytes";
export const PACKAGE_BUDGET_FIELD = "aigpuBundleBudgetGzipBytes";
export const EXPORT_AUDIENCE_FIELD = "aigpuExportBundleAudiences";
export const PACKAGE_AUDIENCE_FIELD = "aigpuBundleAudience";
export const THRESHOLD_FIELD = "aigpuBundleBudgetGrowthThreshold";
export const EXPORT_NOTE_FIELD = "aigpuExportBundleBudgetNote";
export const PACKAGE_NOTE_FIELD = "aigpuBundleBudgetNote";
...
export function stripBudgetMetadata(path, contents) {
  ...
  const keys = Object.keys(manifest).filter((key) => /^aigpu(Export)?Bundle/.test(key));
