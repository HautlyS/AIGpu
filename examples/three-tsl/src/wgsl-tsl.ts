...
/**
 * Bridges aigpu-resolved WGSL modules into three.js TSL nodes.
 *
 * The `@aigpu/wgsl` loader emits `{ version: 1, wgsl }` where `wgsl` is the
 ...
 * the declared name may carry aigpu's `_vgsl_<pathHash>__` mangle prefix.
