...
This example is the minimal main API (`aigpu`) render loop: initialize a headless GPU, create an explicit render target, build a fragment-only fullscreen effect, pass ordinary JS numbers with `set()`, and draw into the target.
