...
import { bevel, toEditable } from "@aigpu/render/edit";
...
(HAS_CONE ? describe : describe.skip)("issue #34 headline pyramid+bevel scene", () => {
  test.skipIf(process.env.AIGPU_DOCKER_TEST !== "1")("renders the pyramid+bevel scene byte-equal to snapshot", async () => {
