# @aigpu/render/edit — Mesh Editing
...
```ts
import { EditableMesh } from "@aigpu/render/edit";
```
...
import type { EditableMeshValue } from "@aigpu/render/edit";
...
```ts
import { toEditable } from "@aigpu/render/edit";
```
...
```ts
import { toEditableWithDiagnostics } from "@aigpu/render/edit";
```
...
```ts
import { toEditableWithDiagnostics } from "@aigpu/render/edit";
import type { EditableMeshValue, MeshEditWarning } from "@aigpu/render/edit";
...
```ts
import type { Device } from "@aigpu/core";
import type { ElementSelection, ElementSet, KernelHandle } from "@aigpu/render/edit";
...
```ts
import { EditableMesh, type EditableMeshValue } from "@aigpu/render/edit";
...
```ts
import type { ElementDomain } from "@aigpu/render/edit";
```
...
```ts
import type { ElementSelection } from "@aigpu/render/edit";
```
...
```ts
import { EditableMesh, type ElementSelection } from "@aigpu/render/edit";
...
```ts
import type { ElementSet } from "@aigpu/render/edit";
```

## Signature

```ts
import type { ElementDomain, ElementSelection, EdgeView, FaceView, ScoredSelection, VertexView } from "@aigpu/render/edit";
...
```ts
import type { ScoredSelection } from "@aigpu/render/edit";
```

## Signature

```ts
import type { ElementDomain, ElementSelection } from "@aigpu/render/edit";
...
```ts
import { EditableMesh, type ScoredSelection } from "@aigpu/render/edit";
...
```ts
import type { VertexView } from "@aigpu/render/edit";
```
...
```ts
import { EditableMesh, type VertexView } from "@aigpu/render/edit";
...
```ts
import type { EdgeView } from "@aigpu/render/edit";
```
...
```ts
import { EditableMesh, type EdgeView } from "@aigpu/render/edit";
...
```ts
import type { FaceView } from "@aigpu/render/edit";
```
...
```ts
import { EditableMesh, type FaceView } from "@aigpu/render/edit";
...
```ts
import type { KernelHandle } from "@aigpu/render/edit";
```
...
```ts
import { EditableMesh, type KernelHandle } from "@aigpu/render/edit";
...
```ts
import { extrude } from "@aigpu/render/edit";
```

## Signature

```ts
import type { EditableMeshValue, ElementSelection, MeshEditWarning } from "@aigpu/render/edit";
...
```ts
import { EditableMesh, extrude } from "@aigpu/render/edit";
...
```ts
import { bevel } from "@aigpu/render/edit";
```
...
```ts
import { EditableMesh, bevel } from "@aigpu/render/edit";
...
```ts
import { inset } from "@aigpu/render/edit";
```
...
```ts
import { EditableMesh, inset } from "@aigpu/render/edit";
...
```ts
import { subdivideEdges } from "@aigpu/render/edit";
```

## Signature

```ts
import type { EditableMeshValue, ElementSelection } from "@aigpu/render/edit";
...
```ts
import { EditableMesh, subdivideEdges } from "@aigpu/render/edit";
...
```ts
import { subdivideFaces } from "@aigpu/render/edit";
```
...
```ts
import { EditableMesh, subdivideFaces } from "@aigpu/render/edit";
...
```ts
import { loopCut } from "@aigpu/render/edit";
```
...
```ts
import { EditableMesh, loopCut } from "@aigpu/render/edit";
...
```ts
import { bridge } from "@aigpu/render/edit";
```
...
```ts
import { EditableMesh, bridge, type ElementSelection } from "@aigpu/render/edit";
...
```ts
import { fillHole } from "@aigpu/render/edit";
```
...
```ts
import { EditableMesh, fillHole, type ElementSelection } from "@aigpu/render/edit";
...
```ts
import { gridFill } from "@aigpu/render/edit";
```
...
```ts
import { EditableMesh, gridFill, type ElementSelection } from "@aigpu/render/edit";
...
```ts
import { dissolveVertices } from "@aigpu/render/edit";
```
...
```ts
import { EditableMesh, dissolveVertices } from "@aigpu/render/edit";
...
```ts
import { dissolveEdges } from "@aigpu/render/edit";
```
...
```ts
import { EditableMesh, dissolveEdges } from "@aigpu/render/edit";
...
```ts
import { dissolveFaces } from "@aigpu/render/edit";
```
...
```ts
import { EditableMesh, dissolveFaces } from "@aigpu/render/edit";
...
```ts
import { mergeByDistance } from "@aigpu/render/edit";
```
...
```ts
import { EditableMesh, mergeByDistance } from "@aigpu/render/edit";
...
```ts
import { healManifold } from "@aigpu/render/edit";
```
...
```ts
import { EditableMesh, healManifold } from "@aigpu/render/edit";
...
```ts
import { recomputeNormals } from "@aigpu/render/edit";
```
...
```ts
import { EditableMesh, recomputeNormals } from "@aigpu/render/edit";
...
```ts
import { MeshEditError } from "@aigpu/render/edit";
```
...
```ts
import { MeshEditWarning } from "@aigpu/render/edit";
```
