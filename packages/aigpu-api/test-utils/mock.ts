...
import { getMockGPUDeviceInstrumentation, type MockGPUDeviceInstrumentation } from "@aigpu/core";

export { createMockAdapter, getMockGPUDeviceInstrumentation };
export type { MockGPUDeviceInstrumentation };

/** Boots a GPU-less `aigpu/mock` instance for unit tests that must not load Dawn. */
