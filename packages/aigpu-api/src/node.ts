import { createNodeAdapter, describeNodeAdapter, nodeAdapterEnvironmentOverride, type NodeAdapterInfo, type NodeAdapterMode } from "@aigpu/adapter-node";
import type { AIGpuAdapter } from "@aigpu/core";
import { createGpu, type Gpu, type InitOptions } from "./init.ts";
export { AGENT_ANIMATION_SHADER, agentAnimation, agentStatusIndex } from "./agent.ts";
export type { AgentAnimation, AgentAnimationOptions, AgentAnimationPatch, AgentAnimationState, AgentColor, AgentColors, AgentStatus } from "./agent.ts";

export { createNodeAdapter } from "@aigpu/adapter-node";
...
export { AIGpuError } from "./errors.ts";
export type { Buffer, Device, ResourceIdentity, Texture, AIGpuAdapter } from "@aigpu/core";
export { Uniform } from "./core/uniform.ts";
export type { UniformOptions } from "./core/uniform.ts";
export type { ResolvedShader, ShaderSource, SourceMap, WGSLAst, WGSLSource } from "@aigpu/wgsl";
...
export type NodeInitOptions = Omit<InitOptions, "adapter"> & { readonly adapter?: NodeAdapterMode | AIGpuAdapter };
...
/** Node headless entrypoint (Dawn via @aigpu/adapter-node). */
