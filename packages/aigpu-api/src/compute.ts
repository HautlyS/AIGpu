...
import { reflectSource, type BindingInfo, type EntryPointInfo, type Reflection } from "@aigpu/wgsl/reflect-source";
...
function computeEntryPoint(reflection: Reflection, label: string, name?: string): EntryPointInfo {
  // A named entry validates existence and stage inside selectEntryPoint (AIGPU-ENTRY-INVALID); only the
