import { Texture, createResourceIdentity, DestroySignal, type Device, type ResourceDestroyCallback, type ResourceIdentity, type UnsubscribeResourceDestroy } from "@aigpu/core";
 ...
 * `AIGPU-SURFACE-DUPLICATE`, because reconfiguring a context out from under a live surface silently
