...
export class InternalTimer {
  ...
  #createRing(): QueryRing {
    return createQueryRing(this.#device, { type: "timestamp", capacity: this.#capacity, label: "aigpu.timer", trackSettled: this.#host.trackSettled, errorSink: this.#host.errorSink });
  }
