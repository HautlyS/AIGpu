...
export class Frame {
   ...
   */
  #attach(value: unknown, target: Target, attached: FrameOwner[], invalid: (value: unknown) => AIGpuError): FramePassAttachResult {
...
function timerAttachmentInvalidError(value: unknown): AIGpuError {
...
function visibilityAttachmentInvalidError(value: unknown): AIGpuError {
...
function isDeviceGoneError(error: unknown): boolean {
  const code = (error as AIGpuError | undefined)?.code;
