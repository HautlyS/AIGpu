import { createMockAdapter } from "@aigpu/adapter-mock";
...
export { createMockAdapter } from "@aigpu/adapter-mock";
export type { CreateMockAdapterOptions } from "@aigpu/adapter-mock";
export { getMockGPUDeviceInstrumentation } from "@aigpu/core";
