...
```ts
import { orbitControls, type OrbitControlsOptions } from "aigpu/scene";
```
...
declare function orbitControls(
  node: import("aigpu/scene").SceneNode,
  options?: import("aigpu/scene").OrbitControlsOptions,
): import("aigpu/scene").OrbitControls;
```
...
**Throws:** `AIGPU-SCENE-VALUE-INVALID` for malformed `target` vectors.

## Examples

```ts
import { clock, init, frameLoop } from "aigpu";
import { orbitControls, perspectiveCamera } from "aigpu/scene";
...
```ts
import type { OrbitControls } from "aigpu/scene";
```
...
declare class OrbitControls {
  ...
  set(values: import("aigpu/scene").OrbitControlsValues): this;
  dispose(): void;
  readonly yaw: number;
...
```ts
import type { OrbitControlsElement } from "aigpu/scene";
```
...
```ts
import type { OrbitControlsOptions } from "aigpu/scene";
```
...
interface OrbitControlsOptions {
  readonly element?: import("aigpu/scene").OrbitControlsElement;
  readonly target?: import("aigpu/scene").Vec3Like;
...
```ts
import type { OrbitControlsValues } from "aigpu/scene";
```
