...
```ts
import { scene } from "aigpu/scene";
```

## Signature

```ts
declare function scene(options?: import("aigpu/scene").NodeOptions): import("aigpu/scene").SceneNode;
```

## Examples

```ts
import { box, group, mesh, scene, unlitMaterial } from "aigpu/scene";
...
```ts
import { group } from "aigpu/scene";
```

## Signature

```ts
declare function group(options?: import("aigpu/scene").NodeOptions): import("aigpu/scene").SceneNode;
```
...
declare function mesh(
  geometry: import("aigpu/scene").SceneGeometry,
  material?: import("aigpu/scene").SceneMaterial,
  options?: import("aigpu/scene").NodeOptions,
): import("aigpu/scene").MeshNode;
```
...
**Throws:** `AIGPU-SCENE-VALUE-INVALID` for malformed transform options.

## Examples

```ts
import { lambertMaterial, mesh, sphere } from "aigpu/scene";
...
- This is the scene-tree `mesh()`; the low-level vertex-buffer API remains `geometry(gpu, ...)` on the main `aigpu` entrypoint.
...
```ts
import type { MeshNode } from "aigpu/scene";
```
...
```ts
import { box, mesh, unlitMaterial } from "aigpu/scene";
...
```ts
import { SceneNode } from "aigpu/scene";
```
...
declare class SceneNode {
  set(values: import("aigpu/scene").NodeTransformValues): this;
  lookAt(target: import("aigpu/scene").Vec3Like, up?: import("aigpu/scene").Vec3Like): this;
  add(...children: SceneNode[]): this;
  remove(...children: SceneNode[]): this;
  removeFromParent(): this;
  traverse(visit: (node: SceneNode) => void): void;
  readonly kind: import("aigpu/scene").SceneNodeKind;
...
**Throws:** `AIGPU-SCENE-CYCLE` when `add()` would create a cycle; `AIGPU-SCENE-VALUE-INVALID` for malformed vectors.
...
```ts
import type { NodeOptions } from "aigpu/scene";
```
...
interface NodeOptions {
  readonly position?: import("aigpu/scene").Vec3Like;
  readonly rotation?: import("aigpu/scene").Vec3Like;
  readonly quaternion?: import("aigpu/scene").QuatLike;
  readonly scale?: number | import("aigpu/scene").Vec3Like;
...
```ts
import { group, mesh, box } from "aigpu/scene";
...
```ts
import type { NodeTransformValues } from "aigpu/scene";
```
...
```ts
import type { Vec3Like } from "aigpu/scene";
```
...
```ts
import type { QuatLike } from "aigpu/scene";
```
...
```ts
import type { SceneNodeKind } from "aigpu/scene";
```
...
```ts
import { scene, mesh, box, type SceneNode } from "aigpu/scene";
