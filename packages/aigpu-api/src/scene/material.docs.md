...
```ts
import { unlitMaterial } from "aigpu/scene";
```

## Signature

```ts
declare function unlitMaterial(options?: import("aigpu/scene").ColorMaterialOptions): import("aigpu/scene").UnlitMaterial;
```

## Examples

```ts
import { srgb, unlitMaterial } from "aigpu/scene";
...
Creates an N·L diffuse material descriptor lit by scene lights (uses `@aigpu/wgsl-std/light` lambert).

## Import

```ts
import { lambertMaterial } from "aigpu/scene";
```

## Signature

```ts
declare function lambertMaterial(options?: import("aigpu/scene").ColorMaterialOptions): import("aigpu/scene").LambertMaterial;
```

## Examples

```ts
import { directionalLight, lambertMaterial, mesh, scene, sphere } from "aigpu/scene";
...
```ts
import { normalMaterial } from "aigpu/scene";
```

## Signature

```ts
declare function normalMaterial(): import("aigpu/scene").NormalMaterial;
```

## Examples

```ts
import { mesh, normalMaterial, torus } from "aigpu/scene";
...
```ts
import { shaderMaterial } from "aigpu/scene";
```
...
declare function shaderMaterial(
  source: string,
  options?: import("aigpu/scene").ShaderMaterialOptions,
): import("aigpu/scene").ShaderMaterial;
```
...
|---|---|---|---|---|
| source | `string` | ✔ | — | WGSL fragment stage. May import from `@aigpu/wgsl-std/*`. |
...
```ts
import { SceneMaterial } from "aigpu/scene";
```
...
declare abstract class SceneMaterial {
  abstract readonly kind: import("aigpu/scene").SceneMaterialKind;
  label: string | undefined;
  blend: import("aigpu/scene").MaterialBlend | undefined;
}
```
...
```ts
import { UnlitMaterial, unlitMaterial, type SceneMaterial } from "aigpu/scene";
...
```ts
import type { UnlitMaterial } from "aigpu/scene";
```
...
declare class UnlitMaterial {
  readonly kind: "unlit";
  set(values: import("aigpu/scene").ColorMaterialValues): this;
...
```ts
import type { LambertMaterial } from "aigpu/scene";
```
...
```ts
import type { NormalMaterial } from "aigpu/scene";
```
...
```ts
import { normalMaterial, type NormalMaterial } from "aigpu/scene";
...
```ts
import type { ShaderMaterial } from "aigpu/scene";
```
...
```ts
import type { ColorMaterialOptions } from "aigpu/scene";
```
...
interface ColorMaterialOptions {
  ...
  readonly opacity?: number;
  readonly blend?: import("aigpu/scene").MaterialBlend;
...
```ts
import type { ColorMaterialValues } from "aigpu/scene";
```
...
```ts
import type { MaterialBlend } from "aigpu/scene";
```
...
```ts
import { unlitMaterial, type MaterialBlend } from "aigpu/scene";
...
```ts
import type { SceneMaterialKind } from "aigpu/scene";
```
...
```ts
import { normalMaterial, type SceneMaterialKind } from "aigpu/scene";
...
```ts
import type { ShaderMaterialOptions } from "aigpu/scene";
```
