import { Buffer, Texture, type ResourceIdentity, type UnsubscribeResourceDestroy } from "@aigpu/core";
...
/** Normalizes resources for the reflected binding kind and rejects incompatible values with aigpu fix-its. */
