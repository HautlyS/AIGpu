import { attachBindGroupLayoutMetadata, type Device } from "@aigpu/core";
import type { BindingInfo, EntryPointInfo, ReflectedBindingLayout, Reflection } from "@aigpu/wgsl/reflect-source";
