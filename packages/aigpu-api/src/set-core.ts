import { bindGroupLayoutMetadata, bindGroupMetadataFor, type Buffer, type Device, type UnsubscribeResourceDestroy } from "@aigpu/core";
import type { BindingInfo, Reflection } from "@aigpu/wgsl/reflect-source";
