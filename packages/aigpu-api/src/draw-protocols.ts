 ...
 */
import type { BindingInfo, EntryPointInputInfo } from "@aigpu/wgsl/reflect-source";
...
export const BINDING_RESOURCE = Symbol("aigpu.bindingResource");
...
export const geometryLayoutResolver = Symbol("aigpu.geometry.layoutResolver");
