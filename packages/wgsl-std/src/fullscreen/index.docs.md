...
```wgsl
import { fullscreenTriangleClip, fullscreenTriangleUv } from "@aigpu/wgsl-std/fullscreen";
```
...
- **See also:** `@aigpu/wgsl-std/color`, `resolveShader`, `wgslVitePlugin`.
