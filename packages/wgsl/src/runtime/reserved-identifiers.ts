...
export const RESERVED_IDENTIFIER_CODE = "AIGPU-WGSL-RESERVED-IDENT";
 ...
 * Dawn/Tint rejects these at shader module creation, so `aigpu check` must catch
...
export function reservedIdentifierDiagnostics(module: ReservedIdentifierModule): Diagnostic[] {
  ...
  while (i < tokens.length) {
    ...
    // `import ... from "..."` is aigpu module syntax; its identifiers are never emitted verbatim.
