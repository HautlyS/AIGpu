...
/** aigpu module syntax extensions accepted by this package before WGSL emission. */
export const AIGPU_MODULE_KEYWORDS: ReadonlySet<string> = new Set(["import", "export", "from", "as"] as const);

export const WGSL_KEYWORDS: ReadonlySet<string> = new Set([...WGSL_SPEC_KEYWORDS, ...AIGPU_MODULE_KEYWORDS]);
