...
test("missing file errors", async () => await expect(resolveShader({ entry: "/missing.wgsl", modules: {}, validate: false })).rejects.toMatchObject({ code: "AIGPU-WGSL-RES-NOTFOUND" }));
