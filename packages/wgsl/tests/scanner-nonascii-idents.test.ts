 ...
 *
 * Unicode identifier support is tracked in https://github.com/hautlys/AIGpu/issues/294.
 */

const CODE = "AIGPU-WGSL-IDENT-NONASCII";
const ISSUE = "https://github.com/hautlys/AIGpu/issues/294";
