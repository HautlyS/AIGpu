...
import { resolveShader, type ResolvedShader } from "@aigpu/wgsl/runtime";
...
test.skipIf(process.env.AIGPU_DOCKER_TEST !== "1")("toy effect(gpu).set() prototype renders offscreen using reflected layout on Dawn", async () => {
