...
/** Fixture that is invalid on purpose — it drives the `aigpu check` diagnostic test. */
const INTENTIONALLY_INVALID = "packages/aigpu-api/tests/fixtures/reserved-word.wgsl";
