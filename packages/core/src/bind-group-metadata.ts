 ...
 * descriptor entries at the point where aigpu creates or receives the layout.
 */
...
/** Returns descriptor metadata previously attached to a layout, if aigpu knows it. */
 ...
 *
 * Raw WebGPU objects created outside aigpu may not have metadata; callers must
...
/** Returns descriptor metadata previously attached to a bind group, if aigpu knows it. */
